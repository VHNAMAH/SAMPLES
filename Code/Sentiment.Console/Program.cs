namespace Sentiment
{
    ...
    {
        static readonly string _dataPath = Path.Combine(Environment.CurrentDirectory, "../Sentiment.Common/Resources", "yelp_labelled.txt");
        static readonly string _modelPath = Path.Combine(Environment.CurrentDirectory, "../Sentiment.Common/Resources", "Generated_Model.zip");
        ...
        static void Main(string[] args)
        {
            ...
            // 2. Load text data and split into training and evaluation
            ...
            // 5. Test Prediction (Single)
            UseModelWithSingleItem(mlContext, model);

            // 6. Test Prediction (Batch)
            UseModelWithBatchItems(mlContext, model);

            // Optional: Export as ZIP
            mlContext.Model.Save(model, splitDataView.TrainSet.Schema, _modelPath);
        ...
        private static void UseModelWithSingleItem(MLContext mlContext, ITransformer model)
        {
            ...
            {
                SentimentText = "I am positive sometimes when I'm sick"
            };
